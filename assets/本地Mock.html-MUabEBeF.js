import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as s,f as a}from"./app-B129XWUr.js";const l={},i=a(`<h2 id="实现原理" tabindex="-1"><a class="header-anchor" href="#实现原理"><span>实现原理</span></a></h2><p>项目集成<a href="https://vite-plugin-mock-dev-server.netlify.app/guide/usage" target="_blank" rel="noopener noreferrer">vite-plugin-mock-dev-server</a></p><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法"><span>使用方法</span></a></h2><ol><li>打开mack服务<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line">配置文件:.env.development</span>
